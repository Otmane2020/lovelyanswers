...
const PLATFORM_GUIDES: Record<string, { title: string; steps: string[] }> = {
  ...
  lovable: {
    ...
    steps: [
      "✅ For THIS Lovable project: Just enter your published site URL (e.g., https://lovelyanswers.com)",
      "📝 Content will be published at your-site.com/blog/{slug}",
      "💡 Make sure to publish your Lovable app to get the public URL",
      "---",
      "🔗 For ANOTHER Lovable project: Enter the Edge Function URL and API Key",
      "💬 Use this prompt in your other Lovable project:",
      "\"Create an Edge Function 'receive-article' that accepts POST { title, body, sourceId } and saves to a 'published_articles' table.\"",
    ],
  },
};
