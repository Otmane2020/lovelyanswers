...
serve(async (req) => {
  ...
  try {
    ...
    // SECURITY: same auth model as auto-generate-shopping — user JWT OR service role.
    ...
    // SECURITY: ownership check — non-service-role callers can only act on their own projects.
